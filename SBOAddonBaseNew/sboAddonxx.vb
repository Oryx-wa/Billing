...
#Region "miscellaneous"
    ...
    Public Function getAppResource(ByVal filename As String) As System.IO.Stream
        ...
        Dim file As System.IO.Stream = Me.AppAssembly.GetManifestResourceStream(AppNameSpace + "." + filename)
...
#Region "Handle Events"
    ...
    Private Sub m_SboApplication_AppEvent(EventType As SAPbouiCOM.BoAppEventTypes) Handles m_SboApplication.AppEvent
            ...
            If pVal.BeforeAction = False Then
                ...
                For Each row In Menuds.Tables(0).Rows
                    If row.Item("MenuUID") = pVal.MenuUID Then
                        If Not Me.checkUserPermission(row.Item("PermCategory")) Then
